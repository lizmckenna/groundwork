...
const EVENT_META = {
  ...
  // ── Fall 2026 training calendar (Ellen G's sheet, added 8/4). All type 'makeup':
  // no per-event Airtable fields; registration = events_signed_up + Event RSVP-less
  // makeup flow; confirmation emails via autoEmailEvent + KV zoomlink:<key>.
  'legis_8_26': { type: 'makeup', date: '2026-08-26', time: '7:00pm CT', label: 'Legislators Training 8/26', emailTitle: 'Meeting with Legislators', confirmEvent: 'Confirm Legis 8/26', attendEvent: 'Meeting with Legislators Training 8/26', confirmField: null, attendField: null, signupField: null, confirmTag: 'legis 8/26 confirm', attendTag: 'legis 8/26', icsTitle: 'Meeting with Legislators (Parents for Missouri Public Schools)' },
  'b2s_9_10': { type: 'makeup', date: '2026-09-10', time: '7:00pm CT', label: 'Back to School Planning 9/10', emailTitle: 'Back to School Planning', confirmEvent: 'Confirm B2S 9/10', attendEvent: 'Back to School Planning 9/10', confirmField: null, attendField: null, signupField: null, confirmTag: 'b2s 9/10 confirm', attendTag: 'b2s 9/10', icsTitle: 'Back to School Planning (Parents for Missouri Public Schools)' },
  'legis_9_16': { type: 'makeup', date: '2026-09-16', time: '7:00pm CT', label: 'Legislators Training 9/16', emailTitle: 'Meeting with Legislators', confirmEvent: 'Confirm Legis 9/16', attendEvent: 'Meeting with Legislators Training 9/16', confirmField: null, attendField: null, signupField: null, confirmTag: 'legis 9/16 confirm', attendTag: 'legis 9/16', icsTitle: 'Meeting with Legislators (Parents for Missouri Public Schools)' },
  'power_9_23': { type: 'makeup', date: '2026-09-23', time: '7:00pm CT', label: 'Power Analysis Training 9/23', emailTitle: 'Power Analysis Training', confirmEvent: 'Confirm Power 9/23', attendEvent: 'Power Analysis Training 9/23', confirmField: null, attendField: null, signupField: null, confirmTag: 'power 9/23 confirm', attendTag: 'power 9/23', icsTitle: 'Power Analysis Training (Parents for Missouri Public Schools)' },
  'vppc_fall': { type: 'makeup', date: '2026-09-24', time: '7:00pm CT', label: 'Virtual Parent Power Camp Fall 2026', emailTitle: 'Virtual Parent Power Camp (four Thursdays, 9/24–10/15)', confirmEvent: 'Confirm VPPC Fall', attendEvent: 'Virtual Parent Power Camp Fall 2026', confirmField: null, attendField: null, signupField: null, confirmTag: 'vppc fall confirm', attendTag: 'vppc fall', icsTitle: 'Virtual Parent Power Camp — Session 1 of 4 (Parents for Missouri Public Schools)' },
  ...
  // Threats to Public Ed Onboarding calls — the fall onboarding nets (Ellen's Fall2026
  // Training Calendar, added 9/4). Zoom REGISTRATION links live in KV zoomlink:threats_*
  // (same pattern as the other fall trainings); confirmation emails carry them.
  'threats_9_15':  { type: 'makeup', date: '2026-09-15', time: '7:00pm CT', label: 'Threats Onboarding 9/15',  emailTitle: 'Threats to Public Ed Onboarding', confirmEvent: 'Confirm Threats 9/15',  attendEvent: 'Threats to Public Ed Onboarding 9/15',  confirmField: null, attendField: null, signupField: null, confirmTag: 'threats 9/15 confirm',  attendTag: 'threats onboarding 9/15',  icsTitle: 'Threats to Public Ed Onboarding (Parents for Missouri Public Schools)' },
  'threats_9_30':  { type: 'makeup', date: '2026-09-30', time: '7:00pm CT', label: 'Threats Onboarding 9/30',  emailTitle: 'Threats to Public Ed Onboarding', confirmEvent: 'Confirm Threats 9/30',  attendEvent: 'Threats to Public Ed Onboarding 9/30',  confirmField: null, attendField: null, signupField: null, confirmTag: 'threats 9/30 confirm',  attendTag: 'threats onboarding 9/30',  icsTitle: 'Threats to Public Ed Onboarding (Parents for Missouri Public Schools)' },
  'threats_10_12': { type: 'makeup', date: '2026-10-12', time: '7:00pm CT', label: 'Threats Onboarding 10/12', emailTitle: 'Threats to Public Ed Onboarding', confirmEvent: 'Confirm Threats 10/12', attendEvent: 'Threats to Public Ed Onboarding 10/12', confirmField: null, attendField: null, signupField: null, confirmTag: 'threats 10/12 confirm', attendTag: 'threats onboarding 10/12', icsTitle: 'Threats to Public Ed Onboarding (Parents for Missouri Public Schools)' },
  'threats_10_29': { type: 'makeup', date: '2026-10-29', time: '7:00pm CT', label: 'Threats Onboarding 10/29', emailTitle: 'Threats to Public Ed Onboarding', confirmEvent: 'Confirm Threats 10/29', attendEvent: 'Threats to Public Ed Onboarding 10/29', confirmField: null, attendField: null, signupField: null, confirmTag: 'threats 10/29 confirm', attendTag: 'threats onboarding 10/29', icsTitle: 'Threats to Public Ed Onboarding (Parents for Missouri Public Schools)' },
  'threats_11_12': { type: 'makeup', date: '2026-11-12', time: '7:00pm CT', label: 'Threats Onboarding 11/12', emailTitle: 'Threats to Public Ed Onboarding', confirmEvent: 'Confirm Threats 11/12', attendEvent: 'Threats to Public Ed Onboarding 11/12', confirmField: null, attendField: null, signupField: null, confirmTag: 'threats 11/12 confirm', attendTag: 'threats onboarding 11/12', icsTitle: 'Threats to Public Ed Onboarding (Parents for Missouri Public Schools)' },
  'threats_12_2':  { type: 'makeup', date: '2026-12-02', time: '7:00pm CT', label: 'Threats Onboarding 12/2',  emailTitle: 'Threats to Public Ed Onboarding', confirmEvent: 'Confirm Threats 12/2',  attendEvent: 'Threats to Public Ed Onboarding 12/2',  confirmField: null, attendField: null, signupField: null, confirmTag: 'threats 12/2 confirm',  attendTag: 'threats onboarding 12/2',  icsTitle: 'Threats to Public Ed Onboarding (Parents for Missouri Public Schools)' },
  ...
  // The three Advocacy Day trainings. 60 minutes for everyone, then a further
  // 30 for team leads, so the block is 90 and durationMin says so.
  'advtrain_11_17': { type: 'makeup', date: '2026-11-17', time: '7:00pm CT', durationMin: 90, label: 'Advocacy Day Training 11/17', emailTitle: 'Advocacy Day Training', confirmEvent: 'Confirm Adv Training 11/17', attendEvent: 'Advocacy Day Training 11/17', confirmField: null, attendField: null, signupField: null, confirmTag: 'adv training 11/17 confirm', attendTag: 'adv training 11/17', icsTitle: 'Advocacy Day Training (Parents for Missouri Public Schools)' },
  'advtrain_11_23': { type: 'makeup', date: '2026-11-23', time: '7:00pm CT', durationMin: 90, label: 'Advocacy Day Training 11/23', emailTitle: 'Advocacy Day Training', confirmEvent: 'Confirm Adv Training 11/23', attendEvent: 'Advocacy Day Training 11/23', confirmField: null, attendField: null, signupField: null, confirmTag: 'adv training 11/23 confirm', attendTag: 'adv training 11/23', icsTitle: 'Advocacy Day Training (Parents for Missouri Public Schools)' },
  'advtrain_12_5': { type: 'makeup', date: '2026-12-05', time: '10:00am CT', durationMin: 90, label: 'Advocacy Day Training 12/5', emailTitle: 'Advocacy Day Training', confirmEvent: 'Confirm Adv Training 12/5', attendEvent: 'Advocacy Day Training 12/5', confirmField: null, attendField: null, signupField: null, confirmTag: 'adv training 12/5 confirm', attendTag: 'adv training 12/5', icsTitle: 'Advocacy Day Training (Parents for Missouri Public Schools)' },
  'advtrain_12_9': { type: 'makeup', date: '2026-12-09', time: '7:00pm CT', durationMin: 90, label: 'Advocacy Day Training 12/9', emailTitle: 'Advocacy Day Training', confirmEvent: 'Confirm Adv Training 12/9', attendEvent: 'Advocacy Day Training 12/9', confirmField: null, attendField: null, signupField: null, confirmTag: 'adv training 12/9 confirm', attendTag: 'adv training 12/9', icsTitle: 'Advocacy Day Training (Parents for Missouri Public Schools)' },
  'advtrain_12_15': { type: 'makeup', date: '2026-12-15', time: '7:00pm CT', durationMin: 90, label: 'Advocacy Day Training 12/15', emailTitle: 'Advocacy Day Training', confirmEvent: 'Confirm Adv Training 12/15', attendEvent: 'Advocacy Day Training 12/15', confirmField: null, attendField: null, signupField: null, confirmTag: 'adv training 12/15 confirm', attendTag: 'adv training 12/15', icsTitle: 'Advocacy Day Training (Parents for Missouri Public Schools)' },
};
