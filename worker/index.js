...
const EVENT_META = {
  ...
  // KC-area camp per the Fall2026 Training Calendar sheet. Time is TBD there —
  // update `time` (and the trainings-page entry) when the team confirms.
  'ppc_kc_10_10': { type: 'makeup', inPerson: true, date: '2026-10-10', time: 'Time TBD', label: 'KC Parent Power Camp 10/10', emailTitle: 'KC Area Parent Power Camp', confirmEvent: 'Confirm KC PPC 10/10', attendEvent: 'KC Parent Power Camp 10/10', confirmField: null, attendField: null, signupField: null, confirmTag: 'kc ppc confirm', attendTag: 'kc ppc 10/10', icsTitle: 'KC Area Parent Power Camp (Parents for Missouri Public Schools)' },
};
