/**
 * Groundwork live turnout tracker — ST. LOUIS launch (Mon 7/6).
...
const RSVP_URL    = 'https://parents4mopublicschools.org/launches/st-louis/';
const CHECKIN_URL = 'https://parents4mopublicschools.org/checkin/st-louis/';
