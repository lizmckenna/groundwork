...
function rebuildHowTo(){
  ...
  const rows=[
    ...
    ['','gap'],
    ['Adding someone new you recruited','h'],
    ['Do NOT type a new person straight into a tab — the next refresh erases any row that is not in the database. To add a recruit, send them the commit form (parents4mopublicschools.org/amendment5/) or a training signup (parents4mopublicschools.org/trainings/). That creates the real record, and they show up in your tab on their own.','note'],
    ['','gap'],
