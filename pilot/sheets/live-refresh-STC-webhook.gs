/**
 * Groundwork live turnout tracker — ST. CHARLES launch (Wed 7/15).
...
const EVENT   = 'St. Charles County Parent Action Meeting 7/15';
...
const RSVP_URL    = 'https://parents4mopublicschools.org/launches/st-charles/';
const CHECKIN_URL = 'https://parents4mopublicschools.org/checkin/st-charles/';
